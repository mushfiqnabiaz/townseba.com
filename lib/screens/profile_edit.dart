...
enum OwnerType { tenant, flat_owner }
...
class _ProfileEditState extends State<ProfileEdit> {
  ...
  TextEditingController _nidNumberController = TextEditingController(text: "${user_nid_number.$}");
  TextEditingController _flatNumberController = TextEditingController(text: "${user_flat_number.$}");
  TextEditingController _passwordController = TextEditingController();
  TextEditingController _passwordConfirmController = TextEditingController();

  OwnerType _ownerType = user_owner_type.$ == "flatOwner" ? OwnerType.flat_owner : OwnerType.tenant;
  ...
  onPressUpdate() async {
    ...
    var nidNumber = _nidNumberController.text.toString();
    var flatNumber = _flatNumberController.text.toString();
    ...
    if (flatNumber == "") {
      ToastComponent.showDialog("Enter your Flat Number", gravity: Toast.center, duration: Toast.lengthLong);
      return;
    }
    ...
    var profileUpdateResponse =
      ...
      nidNumber,
      flatNumber,
      _ownerType.toString().split('.').last,
    );
    ...
    if (profileUpdateResponse.result == false) {
      ...
      user_name.$ = name;
      user_name.save();
      user_nid_number.$ = nidNumber;
      user_nid_number.save();
      user_flat_number.$ = flatNumber;
      user_flat_number.save();
      user_owner_type.$ = _ownerType.toString().split('.').last;
      user_owner_type.save();
      setState(() {});
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  autofocus: false,
                  decoration: InputDecorations.buildInputDecoration_1(
                      hint_text: "Enter Your NID number"),
                ),
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  ListTile(
                    title: const Text('Flat Owner'),
                    leading: Radio<OwnerType>(
                      value: OwnerType.flat_owner,
                      groupValue: _ownerType,
                      onChanged: (value) {
                        setState(() {
                          _ownerType = value;
