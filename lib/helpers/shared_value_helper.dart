...
final SharedValue<String> user_nid_number = SharedValue(
  value: "", // initial value
  key: "user_nid_number", // disk storage key for shared_preferences
);

final SharedValue<String> user_flat_number = SharedValue(
  value: "", // initial value
  key: "user_flat_number", // disk storage key for shared_preferences
);

final SharedValue<String> user_owner_type = SharedValue(
  value: "", // initial value
  key: "user_owner_type", // disk storage key for shared_preferences
);
